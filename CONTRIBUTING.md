...
- Clone the forked repository to your local development machine
  (e.g. `git clone git@github.com:<YOUR_GITHUB_USER>/twitter-ads-api.git`).
...
- When committing your changes, make sure that each commit message is clear
  (e.g. `git commit -m 'Take in an optional something as a parameter to twitter-ads-api'`).
- Push your new branch to your own fork into the same remote branch
  (e.g. `git push origin my-username.my-new-feature`, replace `origin` if you use another remote.)

### 1.3.2. Open a pull request

Go to the [pull request page of twitter_ads_api][prs] and in the top
...
[github issue]: https://github.com/twitter-dart/twitter-ads-api/issues/new
[github issues]: https://github.com/twitter-dart/twitter-ads-api/issues/new
[prs]: https://github.com/twitter-dart/twitter-ads-api/pulls
